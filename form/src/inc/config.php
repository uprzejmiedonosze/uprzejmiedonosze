...
const CATEGORIES = Array(
	...
	6  => ["Parkowanie na trawniku/w parku",
        ...
        "< 1000 zł"],
	1  => [null, "Pojazd był zaparkowany w sposób niezgodny z oznaczeniem pionowym i poziomym.", null, null],
	...
	0 => ["<i>Pozostałe przypadki (koniecznie dodaj komentarz)</i>",
		"",
		"Wyobraźnia kierowców nie zna granic. Jeśli wybierzesz tę katogorię, koniecznie opisz szczegóły w komentarzu do zgłoszenia.", null]
);
