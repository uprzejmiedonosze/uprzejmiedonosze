...
EOD,
        "topics" => [
            "pensja minimalna wzrosła w tym czasie z 800 zł do 4 250 zł",
        ...
        "law" => <<<EOD
Proponuję waloryzację wszystkich pozycji w sekcji K („Zatrzymanie i postój”) o 300% – czyli wyraźnie poniżej wskaźnika wzrostu pensji minimalnej. Równocześnie postulujemy uzupełnienie art. 38 § 2 Kodeksu wykroczeń („Recydywa wielokrotna”) o art. 97 („Naruszenie przepisów o bezpieczeństwie lub porządku w ruchu drogowym”).
...
EOD,
        ...
        "law" => <<<EOD
Rozwiązaniem problemu jest domyślne karanie właściciela pojazdu. Podobnie jak ma to miejsce w przypadku nakładania opłat dodatkowych w SPP. Oczywiście właściciel pojazdu powinien móc skutecznie zwolnić się z obowiązku uiszczenia mandatu pod warunkiem doręczenia organowi dowodu potwierdzającego korzystanie z pojazdu przez osobę trzecią w postaci pisemnego oświadczenia osoby kierującej pojazdem, zawierającego jej dane.
EOD
    ],
    ...
    "6" => [
        ...
        "desc" => <<<EOD
Zgodnie z przepisami o ruchu drogowym), pojazd jest usuwany z drogi na koszt właściciela w przypadku pozostawienia go w miejscu, gdzie jest to zabronione i utrudnia ruch lub w inny sposób zagraża bezpieczeństwu. Niestety prawo drogowe nie definiuje „zagrożenia bezpieczeństwa”. W praktyce, pojazdy są usuwane głównie w przypadku zablokowania ruchu pojazdów, a nigdy, gdy blokują ruch pieszych.
